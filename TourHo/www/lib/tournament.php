...
function generate_tour_menu($tour_id) {
    ...
    if ($tour->team_tournament) {
        ...
        <ul>
                        ...
                        <li><a href=\"index.php?tournament=$tour_id&amp;rank_team=td_pos&amp;total=1\">Touchdowns marqués</a></li>
                        <li><a href=\"index.php?tournament=$tour_id&amp;rank_team=td_neg&amp;total=1\">Touchdowns encaissés</a></li>
                        <li><a href=\"index.php?tournament=$tour_id&amp;rank_team=cas_pos&amp;total=1\">Sorties réalisées</a></li>
                        <li><a href=\"index.php?tournament=$tour_id&amp;rank_team=cas_neg&amp;total=1\">Sorties subies</a></li>
                        <li><a href=\"index.php?tournament=$tour_id&amp;rank_team=foul_pos&amp;total=1\">Agressions réussies</a></li>
                        <li><a href=\"index.php?tournament=$tour_id&amp;rank_team=foul_neg&amp;total=1\">Agressions subies</a></li>
                    </ul>
                </li>";
    ...
    print "<ul>
                        ...
                        <li><a href=\"index.php?tournament=$tour_id&amp;rank=minus&amp;total=1\">Minus</a></li>
                    </ul>
                </li>";    
...
function details_html($tour) {
    ...
    $team_number=count($tour->getTeams());
 ...
 border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
  <tbody>
    ...
    if ($tour->team_tournament) {
      ...
      <td class=\"tab_result\">$tour->team_mates_number joueurs</td>
    </tr>
        <tr>
    ...
    if ($tour->team_tournament) {
        ...
        print"<td class=\"tab_result\">".$tour->getRankingName($tour->rank1)."</td>
            </tr>
            <tr>
